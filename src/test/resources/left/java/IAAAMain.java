 ...
 * 
 * @version $Id: IAAAMain.java 96160 2019-05-23 08:01:03Z jaquiles $
 * 
 */
public class IAAAMain {
	
	// Logger, must not be instantiated until the log configuration has been
	// loaded
	// private static final transient Logger logger = null;

	// This program help file
	private static final String HELP_FILE = "iaaa.help.txt";
